...
# # mainDir="~"
mainDir="/home/MeVlana/"

wget -N https://repo.continuum.io/archive/Anaconda3-4.4.0-Linux-x86_64.sh -P ${mainDir}
bash ${mainDir}/Anaconda3-4.4.0-Linux-x86_64.sh -b -p ${mainDir}/anaconda3

printf '\nexport PATH='${mainDir}'/anaconda3/bin:$PATH' >> ~/.bashrc
export PATH=${mainDir}/anaconda3/bin:$PATH
