...
def main():
	...
	parser.add_argument('--include_sync_to_cirra', type=list, default=[".py", ".sh", ".gz", "NiceRun/*/*/*/.png"])
	...
	parser.add_argument('--cirra_loc', type=str, default='/home/MeVlana/tensorflowCode/')
