...
class Model():
    ...
    def inference(self, batch, additional_inputs_tf):
        ...
        timescale = 25.
        starttime = 15.
        epoch_ratio = (self.epoch-starttime)/timescale)
        ...
        self.mean_POT_primal = self.mean_OT_primal+ (1-2*tf.nn.relu(0.5*(1-epoch_ratio))+tf.nn.relu(-epoch_ratio))*self.config['enc_reg_strength']*self.enc_reg_cost
