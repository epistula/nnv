...
class DataLoader:
	def __init__(self, batch_size, time_steps, cuda = False, image_mode='bilinear', image_size = 64):
		...
		self.dataset_path = '/home/mcgemici/datasets/flowers_data/flowers_'+str(self.image_size)+'_'+image_mode+'/'
		...
		for a,b in self.filename_array:
			if a.split('.')[0] not in self.filename_dict: self.filename_dict[a.split('.')[0]] = {'name': a.split('.')[0]}
