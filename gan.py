...
# from models.TRIPGAN.Model import Model
from models.IMPROVGAN.Model import Model
# from models.WGANGP.Model import Model
    ...
    def train(epoch):
        ...
        if epoch % checkpoint_time == 0:
            ...
            if data_loader.__module__ == 'datasetLoaders.RandomManifoldDataLoader' or data_loader.__module__ == 'datasetLoaders.ToyDataLoader':
                ...
                # disc_cost_real_np = sess.run(train_outs_dict['disc_cost_real'], feed_dict = input_dict_func(batch, np.asarray([0,])))
